...
<body>
<form action="${pageContext.request.contextPath}/addemployee2" method="post">
    <%--页面使用${}获取后台传递的校验信息--%>
    ...
    省：<input type="text" name="address.provinceName"><span
        style="color:red">${requestScope['address.provinceName']}</span><br/>
